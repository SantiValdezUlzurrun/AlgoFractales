...
class Tortuga:
    ...
    pluma arriba/abajo (cambia el atributo a True o False)
    copiar_Tortuga (recibe una tortuga y le cambia sus atributos como si fuera esta pero con la diferencia de que posicion inicial es igual a posicion)
    '''
